...
<body>
    ...
    if (isset($_POST['bt_xacnhan'])) {
      ...
      if ($phone == "" || $address == "" || $email == "") {
        ...
        if ($_SESSION['cart'] == null) { } else {
          // add bill.
          $sql = "INSERT INTO tbl_bill(IdCustomer, Email, Address, Phone, tongTien) VALUES(" . $_SESSION['idLogin'] . ", '" . $email . "', '" . $address . "', '" . $phone . "', '" . $_SESSION['tongTien'] . "')";
