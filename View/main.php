...
tbl_product_detail.IdGroupProduct = tbl_product_group.IdGroupProduct  Order by IdProduct DESC Limit 6";
			...
			<div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 tungsp animated zoomIn">
					<a href="index.php?page=detail&&msp=<?php echo($row['IdProduct']) ?>" class="ten_spnb"><img src="./admin/upload/sanpham/<?php echo($row['Image']); ?>" class="img_spnb"></a>
...
tbl_product_detail.IdGroupProduct = tbl_product_group.IdGroupProduct WHERE OldPrice!=0 Order by Rand() LIMIT 6";
		...
		<div class="danhmucsanpham">
			<h4 class="danhmucsanpham5 animated flash">TIN TỨC TRONG NGÀY</h4>
			<hr style="margin-top: -10px;">
			<?php
			...
			?>
			<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 animated zoomIn">
				<a href="Index.php?page=content&&mattct=<?php echo($row2['IdNews']) ?>"><img src="./admin/upload/tintuc/<?php echo($row2['Image']); ?>" class="image-tt"></a>
		...
		<div class="them" style="margin-top: 50px;">
			...
			<ul>
				<li>
					...
					<p class="mucben">Hổ trợ 24/7.<br>Phone: 0962199791.<br>Email: nguyenvanbay.ptit@gmail.com.vn</p>
				</li>
				<li>
