<div class="cdz-products col-sm-6 space-base">
    <div class="box-style06 product-list-style02">
        <div class="cdz-block-title">
            <p class="h2"><span>Bán chạy</span></p>
        </div>
                ...
                <div class="category-products codazon-filter codazon-list-style-03 " id="grid5caf80343e233">
                    <div class="products-list">
                        <ul class="product-items">
                            ...
                            $sql = "SELECT * FROM product WHERE type = 'best' ORDER BY price DESC LIMIT 4 ";
                                ...
                                <li class="item product-item" style="min-height:auto;">
                                    <div class="product-item-info">
                                        <div class="cdz-product-left cdz-hover-section">
                                            ...
                                            <a href="javascript:void(0)" class="qs-button" giatri="<?php echo $row['id'] ?>" data-toggle="modal" data-target="#cdz-qsiframe">Quick
                                                shop</a>
                                        </div>
