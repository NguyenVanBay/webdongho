                                                ...
                                                <div class="product-item-info">
                                                    <div class="cdz-hover-section">
                                                        ...
                                                        <div class="addto-hover-container">
                                                            <button data-toggle="tooltip"  msp="<?php echo $row['id']; ?>" data-original-title="Add to Cart" type="button" title="" class="button btn-cart"><span><span>Add to Cart</span></span></button>

                                                            <div class="addto-button">
                                                                <span data-toggle="modal" data-target="#cdz-qsiframe">
                                                                    <a href="#" giatri="<?= $row['id'] ?>" class="qs-button" data-original-title="Quick Shop" data-toggle="tooltip">Xem sản phẩm</a>
                                                                </span>
