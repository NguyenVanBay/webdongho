...
if (isset($_POST['bt_submit'])) {
    ...
    $sql = "UPDATE warehouse SET inventory = '$inventory', inventory_actual = '$inventory_actual'";
...
<form method="POST" enctype="multipart/form-data">
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" name="id" value="<?php echo ($row["name"]) ?>" readonly></td>
        </tr>
        <tr>
